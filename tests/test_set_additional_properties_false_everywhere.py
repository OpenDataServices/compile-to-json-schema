...
def test_basic():
    ...
    input_filename = os.path.join(os.path.dirname(os.path.realpath(__file__)),
                                  'fixtures', 'set-additional-properties-false-everywhere', 'test_basic.json')

    ctjs = CompileToJsonSchema(input_filename=input_filename, set_additional_properties_false_everywhere=True)
...
def test_already_set():
    ...
    input_filename = os.path.join(os.path.dirname(os.path.realpath(__file__)),
                                  'fixtures', 'set-additional-properties-false-everywhere', 'test_already_set.json')
