...
def test_file_main():
    ...
    input_filename = os.path.join(os.path.dirname(os.path.realpath(__file__)),
                                  'fixtures', 'simple', 'file-main.json')
...
def test_file_list_anyof():
    ...
    input_filename = os.path.join(os.path.dirname(os.path.realpath(__file__)),
                                  'fixtures', 'simple', 'file-list-anyof.json')
    ...
    assert out['items']['oneOf'][0]['properties']['address']['description'] == 'Where the person lives'
    assert out['items']['oneOf'][1]['properties']['address']['title'] == 'Work Address'
    assert out['items']['oneOf'][1]['properties']['address']['description'] == 'Where the person works'
